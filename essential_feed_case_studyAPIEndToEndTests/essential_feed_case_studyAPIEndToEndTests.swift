//
//  essential_feed_case_studyAPIEndToEndTests.swift
//  essential_feed_case_studyAPIEndToEndTests
//
//  Created by Julius on 21/02/2024.
//

import XCTest
import essential_feed_case_study

final class essential_feed_case_studyAPIEndToEndTests: XCTestCase {
    ...
    func test_EndToEndTestServerGETFeedImageDataResult_matchesFixedAccountData() {
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        let testServer = URL(string: "https://essentialdeveloper.com/feed-case-study/test-api/feed/73A7F70C-75DA-4C2E-B5A3-EED40DC53AA6/image")!
        ...
        _ = loader.loadImageData(from: testServer) { result in
