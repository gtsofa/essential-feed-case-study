...
final class RemoteLoaderTests: XCTestCase {
    ...
    func test_load_deliversMappedResource() {
        ...
        expect(sut, toCompleteWithResults: .success(resource), when: {
    ...
    private func expect(_ sut: RemoteLoader<String>, toCompleteWithResults expectedResult: RemoteLoader<String>.Result, when action: () -> Void, file: StaticString = #filePath,
                        line: UInt = #line) {
