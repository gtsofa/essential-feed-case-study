...
class RemoteFeedImageDataLoader {
    ...
    private class HTTPCientTaskWrapper: FeedImageDataLoaderTask {
    ...
    func loadImageData(from url: URL, completion: @escaping (FeedImageDataLoader.Result) -> Void ) -> FeedImageDataLoaderTask {
        let task = HTTPCientTaskWrapper(completion)
...
final class RemoteFeedImageDataLoaderTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_requestsDataFromURL() {
        ...
        sut.loadImageData(from: url) { _ in } // we do not care about results at the moment
    ...
    func test_loadImageDataFromURL_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
        ...
        sut?.loadImageData(from: anyURL()) { capturedResult in
    ...
    func test_cancelLoadImageDataURLTask_cancelsClientURLRequest() {
        ...
        XCTAssertEqual(client.cancelledURLs, [], "Expected no cancelled URL request until a task is cancelled")
    ...
    private func expect(_ sut: RemoteFeedImageDataLoader, toCompleteWith expectedResult: FeedImageDataLoader.Result, when action: () -> Void, file: StaticString = #filePath,
                        line: UInt = #line ) {
        let url = URL(string: "https://a-given-url.com")!
    ...
    private class HTTPClientSpy: HTTPClient {
        ...
        //complete(withStatusCode: 400, data: anyData(), at: index)
