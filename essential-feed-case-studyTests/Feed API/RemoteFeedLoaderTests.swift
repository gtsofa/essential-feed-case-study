...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompleteWithResults: .failure(RemoteFeedLoader.Error.connectivity), when: {
    ...
    func test_load_deliversErrorOnNon200HTTPURLResponse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompleteWithResults: .failure(RemoteFeedLoader.Error.invalidData), when: {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWithResults expectedResult: RemoteFeedLoader.Result, when action: () -> Void, file: StaticString = #filePath,
                        line: UInt = #line) {
