...
public final class FeedUIComposer {
    ...
    private typealias FeedPresentationAdapter = LoadResourcePresentationAdapter<PaginatedFeed<FeedImage>, FeedViewAdapter>
    // object creation
    public static func feedComposedWith(
        feedLoader:  @escaping () -> AnyPublisher<PaginatedFeed<FeedImage>, Error>,
